...
- `token_budget.preflight` - Optional conservative text-input reservation and
  completion cap before dispatch. Defaults false; isolated budgeted research
  tasks explicitly enable it. Config schema version 41 introduces this field.
