...
> 本文件保留继承自 DeerFlow 的通用功能与运行说明。Agent Investigator 的项目介绍、竞品研究规则和当前验收状态请从 [项目首页](README.md) 与 [文档目录](docs/README.md) 开始。上游站点、社区和演示链接仍指向其原项目。
...
- [DeerFlow 通用运行参考](#deerflow-通用运行参考)
